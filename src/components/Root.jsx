...
export default function Root(){
    ...
    return(
        <div className="mt-8 sm:w-full md:w-full lg:full flex flex-col items-center">
            ...
            <Timer />
            <button className="mb-4" onClick={()=>setOpen(true)}>Mas informacion de Pomodoro</button>
            {
                open ? <Modal /> : null
            }
            <div className="bg-red-500 w-full h-11 flex flex-row justify-center items-center">
                <p className="text-blue-600 font-light text-sm">Coded by Rigoberto Alcantar</p>
            </div>
        </div>
    )
}